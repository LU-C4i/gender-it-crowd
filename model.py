...
class Model(object):
    ...
    def __init__(self, dbhost, dbuser, dbpass, dbname=None, port=3306):
        self.dbhost = dbhost
        self.dbuser = dbuser
        self.dbpass = dbpass
        self.dbname = dbname
    ...
    def connect(self):
        ...
        if self.dbname is None:
            self.db = MySQLdb.connect(self.dbhost, self.dbuser, self.dbpass, port=self.port, cursorclass=MySQLdb.cursors.DictCursor, charset='utf8')
        else:
            self.db = MySQLdb.connect(self.dbhost, self.dbuser, self.dbpass, self.dbname, port=self.port, cursorclass=MySQLdb.cursors.DictCursor, charset='utf8')
